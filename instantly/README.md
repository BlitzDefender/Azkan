...
| Leads | `/leads` | Create, list, fetch, update, delete; bulk add; move between campaigns/lists; interest status |
...
| Analytics | — | Campaign and account metrics: sent, open, click, reply, bounce, unsubscribe |
| API keys | `/api-keys` | Create, list, scope, revoke |
| Workspaces | `/workspaces` | Multi-tenant boundaries for agencies and teams |
